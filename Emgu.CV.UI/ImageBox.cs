...
{
    public delegate void LoadImageEventHandler(object sender, IImage changedImage);
   /// <summary>
   ...
   public partial class ImageBox : PanAndZoomPictureBox
   {
      ...
      #region Events
       ...
       public event LoadImageEventHandler ImageReload;
      #endregion
      ...
      private void loadImageToolStripMenuItem_Click(object sender, EventArgs e)
      {
         if (loadImageFromFileDialog.ShowDialog() == DialogResult.OK)
             try
             {
                 ...
                 IImage newImg = new Image<Bgr, byte>(filename);
                 this.OnImageReload(sender, newImg);
                 Image = newImg;
             }
      ...
      protected override void Dispose(bool disposing)
      {
       ...
       protected virtual void OnImageReload(object sender, IImage changedimage)
       {
           var handler = ImageReload;
           if (handler != null) handler(this, changedimage);
       }
   }
}
